    ...
    <section className="py-20 bg-linear-to-br from-[#B2EBF2]/60 via-[#E0F7FA]/80 to-[#F1F8E9]/60 md:px-20 px-6">
      <div className="mx-auto max-w-[1400px]">
        <div className="flex items-end justify-between mb-10">
          <div>
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-navy">Exclusive Art</h2>
            <p className="text-navy/70 mt-2 font-medium">Art : Anywhere and Everywhere</p>
          </div>
          <Link to="/pricing" className="bg-linear-to-r from-primary to-lime text-white px-6 py-2 rounded-full text-sm font-bold flex items-center gap-1 hover:shadow-lg hover:scale-105 transition-all">
            View All <span className="text-sm">→</span>
          </Link>
        </div>
        <div className="grid grid-cols-1 rounded-2xl sm:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-[200px]">
          {/* Large Hero Card */}
          <Link to="/pricing" className="lg:col-span-2 lg:row-span-2 rounded-2xl overflow-hidden group relative shadow-2xl">
          ...
          {/* Tall Card */}
          <Link to="/pricing" className="lg:col-span-1 rounded-2xl lg:row-span-3 overflow-hidden group relative shadow-xl">
          ...
          {/* Medium Card */}
          <Link to="/pricing" className="lg:col-span-1 rounded-2xl lg:row-span-2 overflow-hidden group relative shadow-xl">
          ...
          {/* Small Card */}
          <Link to="/pricing" className="lg:col-span-1 rounded-2xl lg:row-span-1 overflow-hidden group relative shadow-xl">
